set_attack_value(AT_JAB, AG_SPRITE, sprite_get("attack_A"));
set_attack_value(AT_JAB, AG_NUM_WINDOWS, 3);
set_attack_value(AT_JAB, AG_HURTBOX_SPRITE, sprite_get("attack_A_hurt"));
...
set_hitbox_value(AT_JAB, 1, HG_HITBOX_Y, -60);
set_hitbox_value(AT_JAB, 1, HG_WIDTH, 32); // 20
set_hitbox_value(AT_JAB, 1, HG_HEIGHT, 90);
set_hitbox_value(AT_JAB, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_JAB, 1, HG_DAMAGE, 2); // 3
set_hitbox_value(AT_JAB, 1, HG_ANGLE, 90);
set_hitbox_value(AT_JAB, 1, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_JAB, 1, HG_KNOCKBACK_SCALING, .45);
