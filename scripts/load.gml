...
//sprite_change_offset("attack_G", OFFSET_X, OFFSET_Y, true);
...
sprite_change_offset("attack_R", OFFSET_X, OFFSET_Y, true);
sprite_change_offset("attack_S", OFFSET_X, OFFSET_Y, true);
sprite_change_offset("attack_T", OFFSET_X, OFFSET_Y, true);
sprite_change_offset("attack_U", OFFSET_X, OFFSET_Y, true);
sprite_change_offset("attack_V", OFFSET_X, OFFSET_Y, true);
...
sprite_change_offset("attack_Y_waterstart", 10, 4);
sprite_change_offset("attack_Y_waterbeam", 10, 0);
sprite_change_offset("attack_Y_watertip", 10, 14);
...
sprite_change_offset("hurtbox_F", OFFSET_X*2, OFFSET_Y*2);
sprite_change_offset("hurtbox_F_left", OFFSET_X*2, OFFSET_Y*2);
